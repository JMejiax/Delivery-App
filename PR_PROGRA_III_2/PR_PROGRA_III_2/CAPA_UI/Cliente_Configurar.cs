...
namespace CAPA_UI
{
    public partial class Cliente_Configurar : Form
    {
        ...
        public Cliente_Configurar(Cliente _Cliente)
        {
            this._Cliente = _Cliente;
            InitializeComponent();
        }
        private void Cliente_Configurar_Load(object sender, EventArgs e)
        {
        ...
        public void SetCampos()
        {
            ...
            txtContrasenna.Text = _Cliente.Contrasenna;
            txtNombre.Text = _Cliente.Nombre;
            txtApellidos.Text = _Cliente.Apellidos;
            txtTelefono.Text = _Cliente.NumeroTelefono;
            txtCedula.Text = _Cliente.Cedula;
            txtTarjeta.Text = _Cliente._Tarjeta.numero;
            txtCVV.Text = _Cliente._Tarjeta.cvv;
            fechaVencimiento.Value = _Cliente._Tarjeta.FechaVencimiento;
            rbVisa.Checked = (_Cliente._Tarjeta._TipoTarjeta.Equals(TipoTarjeta.VISA));
            rbMastercard.Checked = (_Cliente._Tarjeta._TipoTarjeta.Equals(TipoTarjeta.MASTERCARD));
            txtLat.Text = _Cliente._Direccion.latitud;
            txtLng.Text = _Cliente._Direccion.longitud;
        ...
        {
            // Coordenadas cliente
            double latInicial = Convert.ToDouble(_Cliente._Direccion.latitud.Replace('.', ','));
            double lngInicial = Convert.ToDouble(_Cliente._Direccion.longitud.Replace('.', ','));
        ...
        private void btnFinalizar_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidarCampos())
                {
                    ...
                    log.Info("Se actualiza la información del usuario " + MenuCliente._Cliente.Correo);
